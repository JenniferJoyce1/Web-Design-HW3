...
?>
     <li class="list-group-item"><?php echo $attendee['Attendee_FirstName']; ?> - <?php echo $attendee['Attendee_LastName']; ?> - <?php echo $attendee['RSVP_Status']; ?> - <?php echo $attendee['Attendee_Email']; ?></li>
<?php    
    }
?>
      </ul>
