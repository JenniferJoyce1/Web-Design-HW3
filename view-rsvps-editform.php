...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editRSVPsModal<?php echo $rsvp['RSVP_ID']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editRSVPsModal<?php echo $rsvp['RSVP_ID']; ?>" tabindex="-1" aria-labelledby="editRSVPsModalLabel<?php echo $rsvp['RSVP_ID']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editRSVPsModalLabel<?php echo $rsvp['RSVP_ID']; ?> ">Edit RSVP</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body"> 
        <form method = "post" action="">
            <div class="mb-3">
              <label for="eID<?php echo $rsvp['RSVP_ID']; ?>" class="form-label">Event ID</label>
